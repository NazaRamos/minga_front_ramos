...
export default function Welcome() {
  return (
    <>
        <h1 className="text-white text-center text-3xl font-medium md:hidden">Your favorite comic book store</h1>
          <h1 className="max-md:hidden text-white md:text-4xl md:font-semibold md:pt-10">Your favorite comic book store✨</h1>
